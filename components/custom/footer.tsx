export function Footer() {
  ...
  return (
    <footer className="w-full border-t border-neutral-200 dark:border-neutral-800 py-12 px-6 md:px-20 lg:px-36">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
        <div className="flex flex-col items-center md:items-start gap-2">
          <div className="flex items-center gap-2 text-lg font-fira">
            <span className="text-emerald-500 font-extrabold">{`//`}</span>
            <span className="font-inter font-bold">
              @elciomf
            </span>
          </div>
          <p className="text-xs text-muted-foreground font-fira uppercase tracking-widest">
        ...
        <div className="flex flex-col items-center md:items-end gap-2">
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              target="_blank"
              className="text-xs text-muted-foreground hover:text-emerald-500 underline decoration-emerald-500/30 underline-offset-4"
            >
              LINKEDIN
            </a>
            <span className="text-neutral-700">•</span>
            <a
              href="https://www.github.com/elciomf/"
              target="_blank"
              className="text-xs text-muted-foreground hover:text-emerald-500 underline decoration-emerald-500/30 underline-offset-4"
            >
              GITHUB
            ...
            <span className="text-neutral-700">•</span>
            <span className="text-[10px] font-inter bg-emerald-500/10 text-emerald-500 px-2 py-0.5 rounded border border-emerald-500/20">
